...
import { Float, toFloat } from 'strict-types/Float';
...
export default class TypedValue {
  ...
  private static MANTISSA_MULT: Float = toFloat(
    1 / (1 << this.COMPLEX_MANTISSA_SHIFT)
  );
  private static RADIX_MULTS: Float[] = [
    this.MANTISSA_MULT,
  ...
  private static DIMENSION_UNIT_STRS: string[] = [
    'px',
    'dip',
    'sp',
    'pt',
  ...
  private static FRACTION_UNIT_STRS: string[] = ['%', '%p'];
